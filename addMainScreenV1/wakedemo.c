...
void main()
{
  ...
  while (1) {			/* forever */
    if (redrawScreen) {
      redrawScreen = 0;
      ledBinary();
      update_triangle_shape(drawTriangleShapeState);
    }
